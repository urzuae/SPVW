...
{
    var contentHtmlFilterTransmsion = "<td class='list'><select style='width: 200px;' name='listTramsmision' id='listTramsmision' style='width:150px;'><option value='0'>Todos</option>";
    $.getJSON(urlFilter,
    {
        transmision: 1,
