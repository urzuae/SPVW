...
{
    var contentHtmlFilterTransmsion = "<td class='list'><select style='width: 200px;' name='listTransmision' id='listTramsmision' style='width:150px;'><option value='0'>Todos</option>";
...
{
    var contentHtmlFilterVersion = "<td class='list'><select style='width: 200px;' name='listVersion' id='listVersion' style='width:150px;'><option value='0'>Todos</option>";        
 ...
 */
$(function(){
    var contentHtmlFilterVehicle = "<td><select style='width: 200px;' name='listVehicle' id='listVehicle' style='width:150px;'><option value='0'>Todos</option>";    
    $.getJSON(urlFilterVehiculos,
    {
        uniteds : 1,
