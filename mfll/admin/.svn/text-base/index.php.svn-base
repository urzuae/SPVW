...
if (!($_COOKIE[_admin_name] == md5($admin_name) && $_COOKIE[_admin_password] == md5($admin_password)))
{
	...
	//mostramos login fields
	print ("<div class=title>Admin login (Sistema MFLL Reportes)</div><br><table><form action=\"index.php\" method=post>\n"
...
function _do_admin_menu()
{
    ...
    $files = array(
                    "Gestión de Usuarios" => "Usuarios&_op=new",
                    "Gestión de Eventos" => "Eventos&_op=new",
                    "<br>Gráficos" => "Reportes&_op=graficas&tipo=1",
                    "&nbsp;&nbsp;&nbsp;&nbsp;Por fase" => "Reportes&_op=graficas&tipo=1",
                    "&nbsp;&nbsp;&nbsp;&nbsp;Concesionaria" => "Reportes&_op=graficas&tipo=2",
                    "&nbsp;&nbsp;&nbsp;&nbsp;(Maneja - Firma)" => "Reportes&_op=graficas_f&tipo=1",
                    "&nbsp;&nbsp;&nbsp;&nbsp;(Compran - Manejan)" => "Reportes&_op=graficas_p&tipo=1",
                    "Busqueda de Prospectos" => "Reportes&_op=consultas",
                    );
