...
if($db->sql_numrows($res) > 0)
{
    ...
    $tabla_resul.="</tbody><thead><tr><td align='left'>Total:</td><td align='center'>".$totales."</td><td align='right'>".number_format($promedio_total,2,'.','')."&nbsp;%</td></tr></thead>
    ...
    if($id == 3)
    {
        ...
        if($db->sql_numrows($res) > 0)
        {
            ...
            $tabla_resul_t.="</tbody><thead><tr><td align='left'>Total:</td><td align='center'>".$totales."</td><td align='right'>".number_format($promedio_total,2,'.','')."&nbsp;%</td><td></td></tr></thead>
                            <thead><tr><td colspan='4'>Total de Prospectos Unicos:  ".$total_unicos."</th></tr></thead></table>";
...
$url_reg="index.php?_module=Gerente&_op=graficas&tipo=".$tipo."&fecha_ini=".$fecha_ini."&fecha_fin=".$fecha_fin."&evento_id=".$evento_id."&submit=sumbit";
