...
// 					  ."<td><a href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=tel\" style=\"color:white;\">Teléfono</a></td>"
      ...
      $nombre2 = $nombres2[$contacto_id];  
	      ...
	      $tabla_campanas .= "<tr class=\"row".(($c++%2)+1)."\">"
							 ."<td>$origen</td>"
	                         ."<td><a target=\"llamada\" href=\"index.php?_module=Campanas&_op=llamada_ro&llamada_id={$llamada_ids[$contacto_id]}&contacto_id=$contacto_id&campana_id={$campana_ids[$contacto_id]}\">
