...
if($_GET["gid"] != ""){
    ...
    #$sql = "select contacto_id from crm_contactos WHERE gid = '$_GET[gid]' and origen_id <> -13";
    $sql = "select contacto_id from crm_contactos WHERE gid = '$_GET[gid]' and year(fecha_importado) IN (2008,2009);";
    $cs = mysql_query($sql);
