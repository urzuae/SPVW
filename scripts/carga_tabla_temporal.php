...
// almaceno los contactos en la tabla temporal
include_once("carga_contactos_nuevos.php");


// calcula fechas de retraso de asignacion y no de reasignaciones de ese periodo de tiempo
include_once("calcula_tiempo_retraso.php");
...
include_once("actualiza_modelo.php");


$sql="delete from reporte_contactos_asignados where contacto_id not in (select contacto_id from crm_contactos);";
$db->sql_query($sql);
