	...
	while(1)
    {
		...
		elseif ($linea > 4)
        {
			...
			list($nombre, $apellidos,$email,$lada, $telefono,$modelo,$medio_contacto,$estado,$ciudad,$concesionaria,
			     ...
			     $lada_movil_2,$telefono_movil_2,$horario_preferido_movil_2,$medio_entero
			     )= $data2;
            ...
            $sql = "INSERT INTO crm_contactos_no_asignados (apellido_paterno,apellido_materno,nombre,tel_casa,
                    ...
                    horario_preferido_oficina_2,horario_preferido_movil_2,medio_entero) VALUES (
                    ...
                    '$horario_preferido_casa_2','$horario_preferido_oficina_2','$horario_preferido_movil_2','$medio_entero_id')";
...
$ins="INSERT INTO crm_prospectos_cargados_call_center (timestamp,archivo,reg_esperados,reg_procesados,reg_insertados,reg_rechazados,reg_alertas)
      VALUES ('".date('Y-m-d H:i:s')."','".$filename."','".$total_de_registros_esperados."','".$procesados."','".$insertados2."','".count($rechazados)."','".count($alertas_motivo)."')";
$res=$db->sql_query($ins) or die("Error en el insert de log se no de prospectos cargados:  ".$ins);
