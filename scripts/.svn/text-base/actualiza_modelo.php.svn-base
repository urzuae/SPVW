...
$sql="SELECT DISTINCT modelo FROM reporte_contactos_asignados ORDER BY modelo;";
...
{
    $upda="UPDATE reporte_contactos_asignados SET modelo_id=".$id_modelo." WHERE modelo='".$modelo."';";
