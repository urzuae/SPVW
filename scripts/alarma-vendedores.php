...
#$sql = "SELECT uid, gid, name, email FROM users WHERE super='8' and gid='0401' AND uid=70095";
...
if ($msg_gral)
{
    ...
    @mail("orangel@pcsmexico.com", "PRUEBA DEL SITIO DE PRUEBAS e-mail de retiro de prospectos de vendedores de concesionarias", "$msg_gral.", $_email_headers);
    @mail("lahernandez@pcsmexico.com", "PRUEBA DEL SITIO DE PRUEBAS e-mail de retiro de prospectos de vendedores de concesionarias", "$msg_gral.", $_email_headers);
}
else
{
    @mail("orangel@pcsmexico.com", "PRUEBA DEL SITIO DE PRUEBAS No hubo retiro de prospectos de vendedores", "", $_email_headers);
    @mail("lahernandez@pcsmexico.com", "PRUEBA DEL SITIO DE PRUEBAS  No hubo retiro de prospectos de vendedores", "", $_email_headers);
}
