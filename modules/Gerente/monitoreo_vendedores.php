...
while (list($campana_id, $name) = htmlize($db->sql_fetchrow($result)))
{
	$campanas[$campana_id] = $name;
        $columnas_tabla.="<td width='3%'>E ".$no_etapa."</td>";
...
if ($rsort)
  ...
  $nrsort = 1;
$tabla_campanas .= "<p align='left'><b>E</b> = Número de Etapa del Ciclo de Venta</p>
                    ...
                    <thead><tr><th rowspan=\"2\">Usuario</th>".$columnas_tabla."
