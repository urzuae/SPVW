...
global $db,$submit,$last_module,$close_after,$uid,$contacto_id,$campana_id,$nombre,$apellido_paterno,
       ...
       $medio_contacto,$medio_entero_id;
...
if (!$contacto_id) //nuevo
{
    ...
    if ($guarda)
    {
        ...
        $sql = "INSERT INTO crm_contactos_no_asignados (nombre, apellido_paterno, apellido_materno,tel_casa, tel_oficina,
                ...
                horario_preferido_oficina_2,horario_preferido_movil_2,medio_entero)
                ...
                '$horario_preferido_movil_2','$medio_entero_id')";
        ...
        $sql = sprintf("INSERT INTO crm_contactos_no_asignados_finalizados
	        ...
	        '%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s',
	        '%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s',
            '%s','%s','%s','%s','%s','%s','%s')", $res["contacto_id"], $uid, $res["gid"], $res["origen_id"], $res["contacto_id"], $res["nombre"],
            ...
            $res['horario_preferido_movil_2'],$res['medio_entero']);
...
$select_medio_entero = select_medio_entero($medio_entero_id,1);
?>