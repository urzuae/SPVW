...
global $db, $contacto_id,$modelo_id,$version_id,$transmision_id,$ano_id,$color_ext,$color_int,$tipo_pint,$modelo_anterior,$version_anterior,$transmision_anterior,$timestamp_anterior;
...
$upd="UPDATE crm_prospectos_unidades SET modelo='".$modelo."',version='".$version."',paquete='".$transmision."',ano='".$ano_id."',tipo_pintura='".$tipo_pint."',color_exterior='".$color_ext."',color_interior='".$color_int."',modelo_id=".$modelo_id.", version_id=".$version_id.", transmision_id=".$transmision_id."
