...
$tit="No se tiene registrado el Id en las Concesionarias";

$nombreConcesionaria=Regresa_Nombre_Concesionaria($db,$gid);
if($nombreConcesionaria != '')
{
    $tit="&Aacute;rbol de Fuentes";
    $nombreConcesionaria.="<br><br><font size='2' color='#333333'>Favor de <b><font color='#800000'>Marcar</font></b> las fuentes que la concesionaria no podrá visualizar</font>";
    $treeString = '';
