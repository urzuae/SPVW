 ...
 */
    ...
    if($db->sql_numrows($res) > 0)
    {
        ...
        while($fila = $db->sql_fetchrow($res))
        {
            ...
            //echo"<br>".$contador."     contacto_id:   ".$fila['contacto_id']."  campana:   ".$fila['campana_id']."     etapa:  ".$tmp_etapa."    gid:  ".$tmp_gid."    nva gid:   ".$_GET['rgid']."    nv campana:   ".$_GET['rgid'].$tmp_etapa;
    ...
    $titulo_reasignado="Se ha bloqueado la concesionaria con id: ".$_GET['gid']." y se ha reasignado a la concesionaria con id: ".$_GET['rgid'];
    $_GET['gid']=$_GET['rgid'];
...
$tupla=$db->sql_fetchrow($result);
//if($db->query_numrows($result) > 0)
if ($tupla[0]>0)
{
    ...
    $_html="<script>
                ...
                {
                    if(confirm('Esta seguro de bloquear la concesionaria: '+name_bloqueado+' y reasignar sus prospectos a la concesionaria con id '+window.document.form.gid_reasignado.value))
                    {
    ...
    $_html .= "<div class=title>Bloqueo de Concesionaria con reasignaci&oacute;n de prospectos</div><br>\n";
    $_html .= "<br>\n";
    ...
    $_html .=  "<tbody>
                ...
                <tr class='row'><td>Concesionaria a bloquear:&nbsp;&nbsp;<font color='#3e4f88'>".$name_bloqueado."</font></td></tr>
                <tr class='row'><td>No de prospectos asignados:&nbsp;&nbsp;<font color='#3e4f88'>".$total_prospectos[0]."</font></td></tr>
                <tr class='row'><td><br>Favor de seleccionar la concesionaria donde se reasignar&aacute;n los prospectos;.\n</td></tr>
...
{
    $_html .= "<br>\n";
    $_html .= "<br>No existen Concesionarias registradas en el Sistema Volkswagen.<br>\n";
}
?>