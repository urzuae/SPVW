<?
  ...
  global $db, $asignar_a, $submit, $seleccionar, $buscar_gid, $order;
...
//         $timestamp = date("d-m-Y",strtotime($timestamp));
  ...
  else $lista_contactos .= "<br><center>No se encontraron contactos con esos datos, porfavor intente de nuevo.</center>";
