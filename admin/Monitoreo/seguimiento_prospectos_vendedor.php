...
global $db, $tabla, $gid, $from, $campana_id, $uid, $orderby,$tmp_filtros,$order,$url, $asignados, $filtroPorVehiculo,$asignados;
...
if( $num > 0)
{
    ...
    $maximo_comp=0;
    $maximo_aten=0;
    $tabla_vendedores.= '<table border="0" class="tablesorter">
                <thead>
                    <tr>
                        <th>Vendedor</th>
                        <th>Asignados</th>
