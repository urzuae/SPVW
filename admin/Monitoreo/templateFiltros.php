...
$buffer_filtros="
        <table width=\"40%\" height=\"190px\" border=\"0\" align=\"center\">
			...
			<thead>
			<tr>
			 <td colspan=2 ><font align=\"center\">Nivel de Concesionaria</font></td>
			</tr>
			</thead>
            <tr class=\"row1\"><td>Nivel</td><td>$select_categoria</td></tr>
			<!--<thead>
			<tr>
			 <td colspan=2 ><img src=\"../img/auto.png\" height=\"16\" width=\"16\"><font align=\"center\">Vehículo</font></td>
			</tr>
			</thead>
			<tr class=\"row1\"><td>Vehículo</td><td>$select_modelo</td></tr>
			-->
			<tr class=\"row2\">
