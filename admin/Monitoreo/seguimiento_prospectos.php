...
$sql="SELECT b.gid,a.name,count(b.gid) as total FROM crm_contactos b LEFT JOIN groups_ubications a ON b.gid=a.gid  WHERE b.gid >0  ".$filtro." ".$filtro_contacto." GROUP by b.gid ORDER BY b.gid limit 10;";
