...
//$filtro_base=" and substr(a.fecha_importado,1,10)<>'0000-00-00' and substr(a.fecha_importado,1,10)<'$fecha_actual'";
...
$sql="SELECT b.padre_id,a.fuente_id,a.nombre FROM crm_fuentes_arbol b,crm_fuentes a WHERE b.padre_id=0 and b.hijo_id=a.fuente_id; ";
