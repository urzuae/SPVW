<?
    ...
    $nsort,$_op,$url,$filtro,$leyenda_filtros,$tmp_filtros,$_dbhost,$_dbuname,$_dbpass,$_dbname;
    ...
    $result = mysqli_query($linkTodb,"CALL reasignaciones_prospectos('$gid','$tmp_origen','$fecha_i','$fecha_c')");
    if (! $result)
    {
