        	...
        	else 
        	{
                ...
                else
                {
                    ...
                    while($data = fgetcsv($fh, 1000, ","))
                    {
                        ...
                        $entidad_federativa_id = array_search(strtr($estado, "_", " "), $_entidades_federativas) + 1;//aguascaluientes es el 1
                        if (!$gid) 
                            continue;
                        $counter++;
                        // zero fill a gid
                        ...
                        if($db->sql_numrows($res) == 0)
                        {
                            ...
                            else
                            {
                                ...
                                if($db->sql_numrows($res) > 0)
                                {
                                    ...
                                    {
                                        if($db->sql_query("INSERT INTO crm_groups_fuentes (gid,fuente_id) VALUES ('".$gid."','".$fuente_id."')"))
                                            $fuentes_bloqueadas++;
                                    }
                                }
                            }
                ...
                $msg ="<table width='60%' align='center' style='border:1px solid #cdcdcd;'><tr bgcolor='#CDCDCD'><td>Resultados de la carga de concesionarias</td></tr>
                        ...
                        <tr><td>Fuentes Bloqueadas:  ".$fuentes_bloqueadas."</td></tr>";
                if($no_errores > 0)
