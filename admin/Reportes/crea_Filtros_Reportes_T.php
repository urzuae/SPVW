...
function getGrafica($tipo)
{
    ...
    $array[2]="Zonas";
    $array[3]="Origenes";
    //$array[4]="Ciclo de Venta";
    //$array[5]="Ciclo de venta de gestionados";
    $array[6]="Total de ventas por concesionaria";
    $array[7]="Total Prospectos por concesionaria";
    $array[8]="Total Procesados por concesionaria";
...
if($grafica != 6)
{
    if($fecha_ini!='' && $fecha_fin=='')
        $tmp_filtros[]="substr(a.fecha_importado,1,10)='".$fecha_ini."'";

    if($fecha_ini=='' && $fecha_fin!='')
        $tmp_filtros[]="substr(a.fecha_importado,1,10)='".$fecha_fin."'";

    if($fecha_ini!='' && $fecha_fin!='')
        $tmp_filtros[]="substr(a.fecha_importado,1,10) BETWEEN '".$fecha_ini."' AND '".$fecha_fin."'";
}
else
{
    $letra="c";
...
if($concesionaria!=0)
{
        ...
        $tmp_filtros[]= "a.gid='".$concesionaria."'";
}

if($origen!=0)
    $tmp_filtros[]= "a.origen_id='".$origen."'";
...
{
    $tmp_filtros[] = "a.modelo_id='$idVehiculo'";
}
if($idVersion)
{
    $tmp_filtros[] = "a.version_id='$idVersion'";
}
if($idTransmision)
{
    $tmp_filtros[] = "a.transmision_id='$idTransmision'";
}
?>