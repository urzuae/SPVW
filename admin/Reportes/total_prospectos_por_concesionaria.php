...
if($gid)
{
    ...
    $titulo = "Reporte Concesionaria $gid";
    $tipo_reporte = "Ciclo";
    $link_excel = "total_prospectos_por_concesionaria_excel&gid=$gid";
...
} else
{
    ...
    $titulo = "Prospectos Por Concesionaria";
    $tipo_reporte = "Concesionaria";
    $link_excel = "total_prospectos_por_concesionaria_excel" . $l_excel;
    $nombre_concesionaria_td = "<td rowspan=\"1\">Nombre</td>";
    $link_grap = "graph_total_prospectos_por_concesionaria";
}
