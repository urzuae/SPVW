<?
	...
	$graph = "<br><iframe style=\"width:650px;height:500px;\" border=\"0\" frameBorder=\"NO\"  SCROLLING=\"NO\" name=\"graph\" src=\"?_module=$_module&_op=graph_ciclos_venta&fecha_ini=$fecha_ini&fecha_fin=$fecha_fin&gid=$gid\">";
	...
	$titulo = "Reporte de contactos por ciclo de venta";
	$link_excel = "ciclo_venta_excel" . $l_excel;
	$contenido_ciclo_venta = "<table>
         <thead>
           <tr>
