...
if ($gid) {
    ...
    $titulo = "Reporte Concesionaria $grupo";
    $tipo_reporte = "Vendedor";
    $link_excel = "total_ventas_por_concesionaria_excel&gid=$gid";
    ...
    $titulo = "Ventas Por Concesionaria";
    $tipo_reporte = "Concesionaria";
    $tipo_reporte_inicio = "<td rowspan=\"1\">#</td>";
    $link_excel = "total_ventas_por_concesionaria_excel".$l_excel;
}
...
$_html_b .= "<h1>Gráfica de Total de ventas por Concesionaria</h1><center>$graph</center>";
