...
$sql = "select distinct(a.contacto_id), llamadas.id, campanas.campana_id,campanas.nombre,
        a.prospecto, a.vendedor, a.horas_retraso_atencion, a.horas_retraso, a.modelo from
        ...
        llamadas.campana_id=campanas.campana_id  where a.uid <> 0  $filtro";
