<?
    ...
    $sql_contactos="SELECT a.contacto_id, a.prospecto, a.origen_id, a.fecha_importado, a.uid,a.gid,a.name AS concesionaria,a.modelo_id,a.modelo,a.no_reasignaciones,a.fecha_log_ultima,a.fecha_log_primera
    FROM ".$tabla." a
    WHERE a.gid > 0 AND a.uid=".$_GET['uid']." AND ".$filtro.";";
